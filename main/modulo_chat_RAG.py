...
hf_token = "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"  # Si lo necesitas, pon tu token de HuggingFace
...
def create_text_pipeline():
    ...
    return pipeline(
        ...
        max_new_tokens=500, # Número máximo de token de salida del modelo.
...
prompt_template = PromptTemplate(
    ...
    template=(
        ...
        "Use solo la información del contexto proporcionado. No invente nada.\n\n"
        "{context}\n\n"
        "Pregunta: {question}\n\n"
        "Respuesta:"
    )
...
if mostrar_metricas and st.session_state.get("ultima_respuesta"):
    query, texto_respuesta, fuentes = st.session_state["ultima_respuesta"]
